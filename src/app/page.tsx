...
const features = [
  {
    ...
    description: "Your conversations are private and secure. No sign-up required, ensuring your complete anonymity.",
    delay: "animation-delay-200",
  },
  {
    icon: <Sparkles className="h-8 w-8 text-primary" />,
    title: "Compassionate AI",
    description: "Powered by Gemini, our AI is designed to listen, understand, and provide supportive guidance.",
     delay: "animation-delay-400",
  },
  {
    icon: <HeartHandshake className="h-8 w-8 text-primary" />,
    title: "Helpful Resources",
    description: "Access a curated list of mental health resources for when you need extra support.",
     delay: "animation-delay-200",
  },
];
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-3">
            {features.map((feature, index) => (
              <Card key={index} className="flex flex-col items-center text-center p-6 animate-in fade-in slide-in-from-bottom-10 duration-1000" style={{animationDelay: `${index * 200}ms`}}>
